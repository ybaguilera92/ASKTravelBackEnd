...
@Service
public class BestAnswersByUserStrategy extends AnswerGetStrategy {
    ...
    public Map<String, Object> getList(BaseDTO baseDTO) {
        ...
        Page<Answer> page = answerRepository.findAllByUserAndBestIsTrueOrderByCreatedDateAsc(pageable, user);
