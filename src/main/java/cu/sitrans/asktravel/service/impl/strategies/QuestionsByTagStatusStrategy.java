...
@Service
public class QuestionsByTagStatusStrategy extends QuestionGetStrategy {
    ...
    public Map<String, Object> getList(BaseDTO baseDTO) {
        ...
        Page<Question> page = questionRepository.findAllByTagsAndStatus(pageable, catalogRepository.findById(questionListDTO.getTag()).
                orElseThrow(() -> new EntityNotFoundException(Catalog.class, questionListDTO.getStatus())),
                catalogRepository.findById(questionListDTO.getStatus()).
                        orElseThrow(() -> new EntityNotFoundException(Catalog.class, questionListDTO.getStatus())));
